...
def premium_quotation_tool(
    ...
    try:
        ...
        debug_info = {
            "llm_passed_revenue": company_revenue_usd,
            "llm_passed_revenue_type": str(type(company_revenue_usd)),
            "llm_passed_is_public": is_public_company,
            "llm_passed_is_public_type": str(type(is_public_company)),
            "active_freq_intercept": FREQ_COEFFICIENTS["intercept"],
            "active_freq_log_rev_coef": FREQ_COEFFICIENTS["log_revenue"],
            "active_sev_intercept": SEVER_COEFFICIENTS["intercept"]
        }
